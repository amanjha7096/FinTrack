...
void _transactionModelSerialize(
  ...
  writer.writeBool(offsets[4], object.isSeeded);
...
TransactionModel _transactionModelDeserialize(
  ...
  object.id = id;
  object.isSeeded = reader.readBool(offsets[4]);
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, bool, QQueryOperations> isSeededProperty() {
    return QueryBuilder.apply(this, (query) {
