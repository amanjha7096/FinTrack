...
import 'package:finance_app/core/services/receipt_scanner_service.dart' as _i9;
import 'package:finance_app/core/theme/theme_cubit.dart' as _i10;
...
import 'package:finance_app/data/repositories/transaction_repository.dart'
    as _i7;
import 'package:finance_app/logic/goal_bloc/goal_bloc.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i9.ReceiptScannerService>(
        () => _i9.ReceiptScannerService());
    gh.factory<_i10.ThemeCubit>(
        () => _i10.ThemeCubit(gh<_i3.IGoalRepository>()));
    gh.factory<_i11.TransactionBloc>(
        () => _i11.TransactionBloc(gh<_i6.ITransactionRepository>()));
    gh.factory<_i12.GoalBloc>(() => _i12.GoalBloc(
          gh<_i3.IGoalRepository>(),
          gh<_i6.ITransactionRepository>(),
        ));
    return this;
